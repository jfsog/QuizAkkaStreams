...
import org.jfsog.grpc_quiz.v1.quiz.gRPCLoginServicePowerApiHandlerFactory;
...
public class QuizAkkaStreamsApplication {
    public static void main(String[] args) {
        ...
        var t = gRPCLoginServicePowerApiHandlerFactory.create(quizloginService, sys);
        var reflection = gRPCLoginServicePowerApiHandlerFactory.createWithServerReflection(quizloginService, sys);
